...
public class ModItems {
    ...
    public static final RegistryObject<Item> COSMIC_MEAT = ITEMS.register("cosmic_meat", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> COSMIC_SNICKERS = ITEMS.register("cosmic_snickers", () -> new Item(new Item.Properties()));
