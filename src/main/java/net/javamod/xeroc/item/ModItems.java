...
public class ModItems {
    ...
    public static final RegistryObject<Item> BAR_BRAWL_MUSIC_DISC = ITEMS.register("bar_brawl_music_disc",
            () -> new RecordItem(6, ModSound.BAR_BRAWL, new Item.Properties().stacksTo(1), 2440));
    ...
    public static final RegistryObject<Item> COSMIC_HELMET = ITEMS.register("cosmic_helmet", () -> new ArmorItem(ModArmorMaterials.COSMIC_INGOT, ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> COSMIC_CHESTPLATE = ITEMS.register("cosmic_chestplate", () -> new ArmorItem(ModArmorMaterials.COSMIC_INGOT, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> COSMIC_BOOTS = ITEMS.register("cosmic_boots", () -> new ArmorItem(ModArmorMaterials.COSMIC_INGOT, ArmorItem.Type.BOOTS, new Item.Properties()));
    public static final RegistryObject<Item> COSMIC_LEGGINGS = ITEMS.register("cosmic_leggings", () -> new ArmorItem(ModArmorMaterials.COSMIC_INGOT, ArmorItem.Type.LEGGINGS, new Item.Properties()));
