...
public class ModItems {
    ...
    public static final RegistryObject<Item> AlIEN_SPAWN_EGG = ITEMS.register("alien_spawn_egg", () -> new ForgeSpawnEggItem(ModEntitys.ALIEN, 0x22b341, 0x19732e, new Item.Properties().tab(ModCreativeTab.XEROC_TAB)));
