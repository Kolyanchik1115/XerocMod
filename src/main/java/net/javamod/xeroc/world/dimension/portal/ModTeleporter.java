//package net.javamod.xeroc.world.dimension.portal;
//
//import net.javamod.xeroc.item.ModBlock;
//import net.javamod.xeroc.item.custom.ModPortalBlock;
...
//                poiType.get() == ModPOIs.XEROC_PORTAL.get(), pos, 64, PoiManager.Occupancy.ANY).sorted(Comparator.<PoiRecord>comparingDouble((poi) ->
...
//                        BlockState blockstate1 = i3 < 0 ? ModBlock.COSMIC_ORE.get().defaultBlockState() : Blocks.AIR.defaultBlockState();
...
//                    this.level.setBlock(mutablePos, ModBlock.COSMIC_ORE.get().defaultBlockState(), 3);
//                }
//            }
//        }
//
//        BlockState kaupenPortal = ModBlock.COSMIC_PORTAL.get().defaultBlockState().setValue(ModPortalBlock.AXIS, axis);
//
...
//        boolean destinationIsUG = level.dimension() == ModDimension.XEROC_KEY;
//        if (entity.level().dimension() != ModDimension.XEROC_KEY && !destinationIsUG) {
//            return null;
//        }
//        else {
