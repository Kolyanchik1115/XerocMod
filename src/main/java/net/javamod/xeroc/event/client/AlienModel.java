...
public class AlienModel extends GeoModel<AlienEntity> {
    ...
    @Override
    public ResourceLocation getModelResource(AlienEntity animatable) {
        return new ResourceLocation(Xeroc.MOD_ID, "geo/alien.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(AlienEntity animatable) {
        return new ResourceLocation(Xeroc.MOD_ID, "textures/entity/alien_texture.png");
    }

    @Override
    public ResourceLocation getAnimationResource(AlienEntity animatable) {
